...
# Load CSV file
csv_file = './results/run8_vel5.csv'  # Replace with your CSV file path
...
# Change of units (apply to filtered data)
filtered_df['CH0'] = filtered_df['CH0'] * (10 / (2**(16-1))) * 100  # 1V is 100°C
filtered_df['CH1'] = filtered_df['CH1'] * (10 / (2**(16-1))) * 100  # 1V is 100°C
...
filtered_df['CH2'] = filtered_df['CH2'] * (xmax0 / (2**(16-1)))
filtered_df['CH3'] = filtered_df['CH3'] * (xmax1 / (2**(16-1)))
